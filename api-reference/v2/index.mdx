...
| `tenant_metadata_schema` | Database-level fields you define up front so metadata can be filtered or quired consistently. | Use it for stable fields like department, customer, region, plan, category, or compliance label. |
