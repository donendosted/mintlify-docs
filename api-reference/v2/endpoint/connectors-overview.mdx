...
| --- | --- | --- |
| [`/connector-catalog`](/api-reference/v2/endpoint/connector-provider-catalog) | `GET` | List supported providers and their configuration |
| [`/connectors/providers`](/api-reference/v2/endpoint/connector-providers) | `GET` | List providers or inspect one in detail |
| [`/connector-discovery`](/api-reference/v2/endpoint/connector-discovery) | `POST` | Preview resources with supplied credentials |
| [`/connectors`](/api-reference/v2/endpoint/create-connector) | `POST` | Create a new connector |
| [`/connectors/:id/credentials`](/api-reference/v2/endpoint/rotate-connector-credentials) | `PATCH` | Rotate OAuth refresh token (internal) |
...
```text
GET  /connector-catalog              -> discover available providers and credential schemas
