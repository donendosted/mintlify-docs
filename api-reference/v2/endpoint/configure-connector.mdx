...
```bash cURL
curl -X POST 'https://api.hydradb.com/connectors/2438363e-bea9-4044-bda0-7a90d9437978/configure' \
...
| <Field name="metadata" type="object" /> | Key-value pairs merged into tenant metadata on every synced object from this resource. Keys must be declared in `tenant_metadata_schema`. |
