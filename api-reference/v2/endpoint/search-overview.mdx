...
| <Field name="source" /> | `"knowledge"` \| `"memories"` \| `"all"` | What collection to search over. `"all"` runs `sources` and `memories` in parallel and merges by `relevancy_score`. (default=`"knowledge"`) |
