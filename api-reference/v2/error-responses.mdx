...
| `TENANT_ALREADY_EXISTS` | `409` | `POST /databases` received a `database` (formerly `tenant_id`) that is already in use. |
| `TENANT_NOT_FOUND` | `404` | The requested database does not exist or is not visible to the current API key. |
