...
`additional_metadata` is the canonical v2 name. `document_metadata` is accepted as a legacy alias inside `metadata_filters`, but new integrations should use `additional_metadata`.
