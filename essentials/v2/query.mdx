...
| Recent uploads don't appear in results | Indexing not finished | Poll `GET /context/status/id (todo)`  -  chunks are invisible until processing reaches at least `graph_creation`. |
