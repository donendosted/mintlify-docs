...
> **Batch limit**: Max 20 sources per request. Wait 1 second between batches. Always call `GET /source/status` before running recall - queries against unindexed sources return empty results.
